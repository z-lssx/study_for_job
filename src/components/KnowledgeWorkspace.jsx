...
export function KnowledgeWorkspace() {
  ...
  return <section className="knowledge-workspace">
    ...
    <div className="knowledge-grid">
      <form className="knowledge-card knowledge-create" onSubmit={createCard}>
        <div className="knowledge-card-title"><Plus size={16} /><strong>新增知识卡片</strong></div>
      ...
      <div className="knowledge-list">
        ...
        {cards.map((card) => <article className="knowledge-card" key={card.id}>
          ...
          {card.notes && <p className="knowledge-notes">{card.notes}</p>}
